...
# 需要给定的参数
model_name = 'new_weights/stdcghosthead10_epoch295.onnx'
class_num = 1

node_remove_start = ['Transpose_230', 'Transpose_248', 'Transpose_266']
node_remove_end = ['Conv_246', 'Conv_264']
reshape_param_list = ['onnx::Reshape_553', 'onnx::Reshape_564',  'onnx::Reshape_575']
reshape_node = ['Reshape_229', 'Reshape_247', 'Reshape_265']

output_name = 'new_weights/stdcghosthead10_epoch295_removed.onnx'
